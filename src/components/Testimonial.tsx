...
const TrustSection: React.FC = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-24 bg-white text-center">
      <h2 className="text-2xl sm:text-3xl lg:text-5xl font-normal lg:font-normal mb-8 text-gray-800">Why Trust Us?</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
        {currentTestimonials.map((testimonial, index) => (
          <div key={index} className="p-4 sm:p-6 border border-yellow-500 rounded-lg max-w-sm bg-white">
